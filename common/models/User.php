...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function rules() {
        return [
                ...
                [['username'], 'unique', 'message' => 'El usuario ya existe'],
                [['email'], 'unique', 'message' => 'El correo electrónico ya está registrado'],
        ];
    }
    ...
    public function getUserRegistros() {
        return $this->hasMany(UserRegistro::className(), ['idUser' => 'id']);
    }
